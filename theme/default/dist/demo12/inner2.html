				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title ">Inner Page</h3>
							</div>
							<div>
					...
					<!-- END: Subheader -->
					<div class="m-content">
						<code>Partial not found: C:\wamp64\www\keenthemes\themes\themes\metronic\dist\preview\inc/view/demos/demo12/pages/inner2.php</code> </div>
				</div>
			</div>
